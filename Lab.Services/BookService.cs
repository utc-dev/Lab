...
{
	class BookService : Service<Book, int>, IBookService
	{
		public BookService(LabDataContext context, IServiceProvider serviceProvider, ILogger<BookService> logger) : base(context, serviceProvider, logger)
		{
		}
