...
import { ChiTietHoaDonColumns } from './chi-tiet-hoa-don.columns';
import { ChiTietHoaDonForm, HoaDonForm } from './forms';
...
const {
  ...
  name: apiName,
  title: title,
  columns: ChiTietHoaDonColumns,
  components: {
    addForm: ChiTietHoaDonForm,
    editForm: ChiTietHoaDonForm,
    viewForm: HoaDonForm,
  },
  events: {
    onAdd: (model) => {
