...
import { KeHoachColumns } from './ke-hoach.columns';
import { KeHoachForm } from './forms';
import { DEFAULT_YEAR, SCHOLASTICS } from 'src/constants';

const title = 'Kế hoạch';
const apiName = 'ke-hoach';
